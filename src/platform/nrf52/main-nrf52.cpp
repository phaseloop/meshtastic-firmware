...
#define SAFE_VDD_VOLTAGE_THRESHOLD_HYST 0
#endif
...
void powerHAL_platformInit()
{
    ...
    // Set to some low value as last resort - powerHAL_isPowerLevelSafe uses different method and should manage proper node behaviour on its
    // own.
